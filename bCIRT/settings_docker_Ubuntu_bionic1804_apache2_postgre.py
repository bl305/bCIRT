...
# custom_variables.py
try:
    from bCIRT.custom_variables import BCIRT_SQL_DATABASE
except Exception:
    BCIRT_SQL_DATABASE = None
try:
    from bCIRT.custom_variables import BCIRT_DEBUG
except Exception:
    BCIRT_DEBUG = None
try:
    from bCIRT.custom_variables import BCIRT_SECRET_KEY
except Exception:
    BCIRT_SECRET_KEY = None
try:
    from bCIRT.custom_variables import BCIRT_PATH
except Exception:
    BCIRT_PATH = None
try:
    from bCIRT.custom_variables import BCIRT_ALLOWED_HOSTS
except Exception:
    BCIRT_ALLOWED_HOSTS = None
try:
...
PROJECT_ROOT = None
if BCIRT_PATH is None:
    # PROJECT_ROOT = '/var/www/html/bCIRT'
    PROJECT_ROOT = '/bCIRT/var/www/html/bCIRT'
else:
    PROJECT_ROOT = BCIRT_PATH
...
if BCIRT_SECRET_KEY:
    SECRET_KEY = BCIRT_SECRET_KEY
# SECURITY WARNING: don't run with debug turned on in production!
# For dev to serve static files you need DEBUG=True
# Set the env variable BCIRT_DEBUG=TRUE
DEBUG = False
if BCIRT_DEBUG:
    DEBUG = True

ALLOWED_HOSTS = list()
if BCIRT_ALLOWED_HOSTS is not None:
    for myhosts in BCIRT_ALLOWED_HOSTS:
...
# STATIC_ROOT = '/bCIRT/var/www/bCIRT/static'
# STATIC_ROOT = '/'
