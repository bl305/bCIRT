    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            if form.data:
                ...
                if datatmp.get('starttime'):
                    starttime = datatmp.get('starttime')
                    # datastarttime = datatmp.get('starttime')
                    ...
                    searchstarttime = starttime
                if datatmp.get('endtime'):
                    endtime = datatmp.get('endtime')
                    # dataendtime = datatmp.get('endtime')
